...
<div id="comments">
    ...
    <div id="respond">
            ...
            <fieldset>
                ...
                <input type="text" name="author" id="author" value="<?php echo $comment_author; ?>" class="form-control input-lg mb-15" />
 
                <label for="email">Email:</label>
                <input type="text" name="email" id="email" value="<?php echo $comment_author_email; ?>" class="form-control input-lg mb-15" />
 
                <label for="url">Website:</label>
                <input type="text" name="url" id="url" value="<?php echo $comment_author_url; ?>" class="form-control input-lg mb-15" />
 
                <?php endif; ?>
 
                <label for="comment">Mensagem:</label>
                <textarea name="comment" id="comment" rows="5" cols="" class="form-control mb-15"></textarea>
 
                <input type="submit" class="commentsubmit btn btn-default btn-lg mb-25" value="Enviar Comentário" />
